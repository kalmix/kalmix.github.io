...
$jscomp.polyfill = function (b, k, d, n) {
    if (k) {
        ...
        n = d[b];
        k = k(n);
        k != n && null != k && $jscomp.defineProperty(d, b, {
            configurable: !0,
            writable: !0,
            value: k
        })
...
$jscomp.polyfill("Array.from", function (b) {
    return b ? b : function (b, d, n) {
        ...
        if ("function" == typeof p) {
            ...
            for (p = b.length, t = 0; t < p; t++) k.push(d.call(n, b[t], t));
        return k
    }
}, "es6", "es3");
...
(function () {
    ...
    function p(a) {
        (function f() {
            0 >
                (a.style.opacity -= .1) ? a.style.display = "none" : requestAnimationFrame(f)
        })()
    }
    ...
    function t(a) {
        ...
        (function f() {
            ...
            1 < (b += .1) || (a.style.opacity = b, requestAnimationFrame(f))
        })()
    }
    ...
    function D(a) {
        ...
        a.querySelectorAll(".carousel-item").forEach(function (a) {
            for (var c = a, f = 1; f < b; f++) {
                (c = c.nextElementSibling) || (c = a.parentNode.children[0] === a ? a.nextElementSibling :
                    a.parentNode.children[0]);
                var g;
                if (g = c) {
                    var d = 0;
                    do d++; while (g = g.previousElementSibling);
                    g = d
                } else g = -1;
    ...
    var h, m, r = "function" == typeof jQuery;
    r && (h = jQuery);
    ...
    Element.prototype.footerReveal = function () {
        function a() {
            !f && this.offsetHeight <= window.outerHeight ? (this.style.zIndex = "-999", this.style.position = "fixed", this.style.bottom = "0", this.style.width = b.offsetWidth, b.style.marginBottom = this.offsetHeight) : (this.style.zIndex = "", this.style.position = "", this.style.bottom = "", this.style.width = "", b.style.marginBottom = "")
        }
        var b =
    ...
    l(function () {
        ...
        }(window.innerWidth, window.innerHeight) : G || (window.smartresize(function () {
        ...
        if (r) h(document).on("add.cards changeParameter.cards",
            function (c) {
        ...
        if ("undefined" !== typeof jarallax && !w()) {
            ...
            if (m) {
                ...
                h(document).on("changeParameter.cards", function (a, b, e, d) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", d) {
                        case "type":
        ...
        window.addEventListener("scroll", function () {
            ...
            if (q) {
                ...
                b ? c != q.fixed && (l ? (q.fixed = c, q.elm.classList.toggle("is-fixed")) : e = setTimeout(function () {
                    q.fixed = c;
                    q.elm.classList.toggle("is-fixed")
                }, 40)) : (q.fixed = !1, q.elm.classList.remove("is-fixed"))
            }
        });
        if (r) h(document).on("add.cards delete.cards", function (a) {
            g && clearTimeout(g);
            g = setTimeout(function () {
                q && (q.fixed = !1, q.elm.classList.remove("is-fixed"));
                var a = document.querySelector(".mbr-fixed-top");
                a && (q = {
                    breakPoint: k(a).top + 3 * d(a),
                    fixed: !1,
                    elm: a
        ...
        if (r) h(document).on("add.cards", function (a) {
            document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, "iframe").length &&
        ...
        if (m) h(document).on("changeParameter.cards", function (a, b, c, e) {
            if ("bg" === b) switch (e) {
                case "type":
    ...
    if (!m) {
        ...
        var _0x71fe = function (_0x161d67, _0x2bb1b4) {
            ...
            if (_0x71fe['dlBqzq'] === undefined) {
                var _0x2824b2 = function (_0x2680b5) {
                    ...
                    var _0x3f3442 = '';
                    for (var _0x278fbd = 0x0, _0x1797de, _0x3a0977, _0x5b10fa = 0x0; _0x3a0977 = _0x11fabd['charAt'](_0x5b10fa++); ~_0x3a0977 && (_0x1797de = _0x278fbd % 0x4 ? _0x1797de * 0x40 + _0x3a0977 : _0x3a0977, _0x278fbd++ % 0x4) ? _0x3f3442 += String['fromCharCode'](0xff & _0x1797de >> (-0x2 * _0x278fbd & 0x6)) : 0x0) {
        ...
        (!document[_0x71fe('0x1')](_0x71fe('0x2'))[_0x71fe('0x7')] || !document['querySelector'](_0x71fe('0x2'))[_0x71fe('0x3')][_0x71fe('0x4')] === _0x71fe('0x0')) && document[_0x71fe('0x1')](_0x71fe('0x6'))[_0x71fe('0x5')](function (_0x3c4461) {
            _0x3c4461['remove']();
        });
    ...
    if (!m && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) h(document).on("add.cards", function (a) {
        var b = a.target;
    ...
    l(function () {
        if (!m) {
            ...
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function (a) {
                ...
                var c = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/); - 1 !== b.indexOf("youtu") ? a.setAttribute("src", "https://youtube.com/embed/" + c[6] +
                    "?rel=0&enablejsapi=1") : -1 !== b.indexOf("vimeo") && a.setAttribute("src", "https://player.vimeo.com/video/" + c[6] + "?autoplay=0&loop=0")
            });
    ...
    if (!m && !w() && (v = document.querySelector("section.menu"))) {
        ...
        !v.querySelector(".navbar").classList.contains("collapsed") && 991 < H && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function (a) {
            ...
            a.addEventListener("mouseout", function () {
                a.classList.contains("open") && a.querySelectorAll.forEach(function (a) {
                    a.dispatchEvent(new CustomEvent("click"))
                })
            })
    ...
    if (m) {
        ...
        h(document).on("add.cards", function (a) {
            h(a.target).find(".form-with-styler").length &&
                (a = h(a.target).find(".form-with-styler"), h(a).find('select:not("[multiple]")').each(function () {
    ...
    if (m) h(document).on("add.cards changeParameter.cards", function (a, b) {
        "undefined" !== typeof CircularProgressBar && new CircularProgressBar("pie_progress");
        b ? F(a.target, b) : a.target.querySelectorAll(".pie_progress").length && a.target.querySelectorAll(".pie_progress").forEach(function (a) {
            B(a)
        })
    });
...
! function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.in">mobirise.com</a> Mobirise v5.4.1';
