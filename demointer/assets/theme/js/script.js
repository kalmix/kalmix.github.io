...
$jscomp.polyfill = function (b, h, d, q) {
  if (h) {
    ...
    q = d[b];
    h = h(q);
    h != q && null != h && $jscomp.defineProperty(d, b, {configurable: true, writable: true, value: h});
  }
};
$jscomp.polyfill("Array.from", function (b) {
  return b ? b : function (b, d, q) {
    ...
    var h = [], p = "undefined" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
    if ("function" == typeof p) {
      b = p.call(b);
      for (var r = 0; !(p = b.next()).done;) h.push(d.call(q, p.value, r++));
    } else for (p = b.length, r = 0; r < p; r++) h.push(d.call(q, b[r], r));
    return h;
  };
}, "es6", "es3");
...
$jscomp.findInternal = function (b, h, d) {
  ...
  for (var q = b.length, l = 0; l < q; l++) {
    var p = b[l];
    if (h.call(d, p, l, b)) return {i: l, v: p};
  }
  return {i: -1, v: void 0};
};
...
$jscomp.polyfill("String.prototype.startsWith", function (b) {
  return b ? b : function (b, d) {
    ...
    b += "";
    var l = h.length, p = b.length;
    d = Math.max(0, Math.min(d | 0, h.length));
    for (var r = 0; r < p && d < l;) if (h[d++] != b[r++]) return false;
    return r >= p;
  };
}, "es6", "es3");
...
$jscomp.polyfill("Array.prototype.includes", function (b) {
  return b ? b : function (b, d) {
    ...
    for (0 > d && (d = Math.max(d + l, 0)); d < l; d++) {
      var p = h[d];
      if (p === b || Object.is(p, b)) return true;
    }
    return false;
  };
}, "es7", "es3");
...
(function () {
  ...
  function w(a) {
    var c = [], b = {blackberry: "BlackBerry", android: "Android", windows: "IEMobile", opera: "Opera Mini", ios: "iPhone|iPad|iPod"};
  ...
  function y(a) {
    var c = a.getAttribute("id") + "-carousel", b = a.getAttribute("data-bs-version") && a.getAttribute("data-bs-version").startsWith("5");
  ...
  function F(a) {
    var c = a.querySelectorAll(".carousel-item").length, b = a.querySelector(".carousel-inner").getAttribute("data-visible");
    c < b && (b = c);
    ...
    a.querySelectorAll(".carousel-item").forEach(function (a) {
      for (var c = a, e = 1; e < b; e++) {
        ...
        d = c.querySelector(".col-md-12").cloneNode(true);
  ...
  function G(a) {
    var b = "", e = a.querySelector("svg linearGradient");
    if (e) {
      b = [];
  ...
  function z(a, b, e) {
    var c = a.closest(".card"), f = c.parentElement.classList;
    c.getAttribute("style") || c.setAttribute("style", "-webkit-flex-basis: auto; flex-basis: auto;");
    f.contains("row") && (f.remove("row"), f.add("media-container-row"));
  ...
  function D(a) {
    var b = a.closest("section").getAttribute("id") + "-svg-gradient", e = +a.getAttribute("data-goal");
    z(a, b, e);
  }
  function H(a, b) {
    if (a.classList.contains("circle-progress-section") && b.includes("progress") && "progressCount" != b) if (b.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function (b) {
      var c = a.getAttribute("id") + "-svg-gradient", f = +b.getAttribute("data-goal");
      z(b, c, f);
    }); else {
  ...
  Element.prototype.footerReveal = function () {
    function a() {
      !d && b.offsetHeight <= window.outerHeight ? (b.style.zIndex = "-999", b.style.position = "fixed", b.style.bottom = "0", b.style.width = e.offsetWidth + "px", e.style.marginBottom = b.offsetHeight + "px") : (b.style.zIndex = "", b.style.position = "", b.style.bottom = "", b.style.width = "", e.style.marginBottom = "");
    }
    var b = this, e = b.previousElementSibling, d = !!document.documentMode;
    a();
  ...
  (function (a) {
    var b = function (a, b, c) {
      ...
      return function () {
        ...
        f ? clearTimeout(f) : c && a.apply(e, d);
  ...
  var I = function () {
    var a = document.createElement("div"), b = document.querySelector("body");
    a.setAttribute("style", "height: 50vh; position: absolute; top: -1000px; left: -1000px;");
    b.appendChild(a);
    var d = parseInt(window.innerHeight / 2, 10), k = parseInt((window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).height, 10);
    b.removeChild(a);
    return k == d;
  }();
  l(function () {
    function a(a) {
      a.style.height = 9 * parseFloat(getComputedStyle(a.parentNode, null).width.replace("px", "")) / 16 + "px";
    }
    function c(a) {
      setTimeout(function () {
    ...
    function e(a) {
      b(a, "[data-bg-video]").forEach(function (a) {
        ...
        if (b) {
          var c = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/), f = a.querySelector(".mbr-background-video-preview") || document.createElement("div");
          ...
          if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3]))) if (c && /youtu\.?be/g.test(c[3])) {
            ...
            d.onload = function () {
              ...
              a.querySelector(".mbr-background-video-wrapper") && a.querySelector(".mbr-background-video-wrapper").remove();
              ...
              var x = d.naturalHeight, k = d.naturalWidth, n = d.naturalHeight / d.naturalWidth, E = b.parentNode.clientHeight, h = b.parentNode.clientWidth;
              x = x < E ? x : E;
              k = k > h ? k : h;
              x / k != n && (x = k * n);
              var u = new YouTubePlayer(b, {modestBranding: true, autoplay: true, controls: false, origin: "*", iv_load_policy: false, mute: true, keyboard: false, captions: false, annotations: false, related: false});
            ...
            if (c && /vimeo/g.test(c[3])) {
              ...
              e.open("GET", "https://vimeo.com/api/v2/video/" + c[6] + ".json", true);
              e.onreadystatechange = function () {
                if (4 === this.readyState) if (200 <= this.status && 400 > this.status) {
              ...
              a.childNodes[1].before(e);
              b = new Vimeo.Player(e, {id: b, loop: true, background: true, responsive: true, autoplay: true, byline: false, title: false, muted: true, controls: false});
      ...
      if (m) {
        ...
        g(document).on("changeParameter.cards", function (a, b, f, e) {
          if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".mbr-background-video-preview").remove(), g(a.target).find(".mbr-background-video").remove(), e) {
            case "type":
              true === f.parallax && c(a.target);
              break;
            case "value":
              "image" === f.type && true === f.parallax && c(a.target);
              break;
            case "parallax":
              true === f.parallax && c(a.target);
          }
    ...
    var k, f, C = 0, n = null, l = !w();
    window.addEventListener("scroll", function () {
      f && clearTimeout(f);
      var a = document.documentElement.scrollTop, b = a <= C || l;
      C = a;
      if (n) {
        ...
        }, 40)) : (n.fixed = false, n.elm.classList.remove("is-fixed"));
      }
    });
    if (t) g(document).on("add.cards delete.cards", function (a) {
      k && clearTimeout(k);
      k = setTimeout(function () {
        n && (n.fixed = false, n.elm.classList.remove("is-fixed"));
        var a = document.querySelector(".mbr-fixed-top");
        a && (n = {breakPoint: h(a).top + 3 * parseFloat(getComputedStyle(a, null).height.replace("px", "")), fixed: false, elm: a}, a.dispatchEvent(new CustomEvent("scroll")));
      }, 650);
    });
    window.smartresize(function () {
      document.querySelectorAll(".mbr-embedded-video").forEach(function (a) {
        a.style.height = (parseFloat(getComputedStyle(a, null).width.replace("px", "")) * parseInt(a.getAttribute("height") || 315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px";
      });
    });
        ...
        if (!b.parents().some(function (a) {
          ...
          do if (b.hash) {
            ...
            document.querySelector(c ? "body" : b.hash).forEach(function (c) {
              a.preventDefault();
              var f = b.parents().some(function (a) {
                return a.classList.contains("navbar-fixed-top");
              }) ? 60 : 0;
              f = "#bottom" == b.hash ? parseFloat(getComputedStyle(c, null).height.replace("px", "")) - window.innerHeight : h(c).top - f;
              c.classList.contains("panel-collapse") || c.classList.contains("tab-pane") || window.scrollTo({top: f, left: 0, behavior: "smooth"});
            });
            break;
    ...
    document.querySelectorAll(".cols-same-height .mbr-figure").forEach(function (a) {
      function b() {
        ...
        if (k && e) {
          ...
          a.style.right = "0";
          a.style.bottom = "0";
          var n = parseFloat(getComputedStyle(f, null).height.replace("px", "")) / parseFloat(getComputedStyle(f, null).width.replace("px", ""));
          n > b && (b = 100 * (n - b) / b, c.style.width = b + 100 + "%", c.style.maxWidth = b + 100 + "%", c.style.marginLeft = -b / 2 + "%");
        }
      }
      var c = a.querySelector("img"), f = a.parentNode, e = c.width, k = c.height;
  ...
  if (!m) {
    var georgios = buckner, myshayla = morocco;
    (function (kerek, partha) {
      var vannya = buckner, jaqualla = morocco, olbin = kerek();
      while (true) {
        try {
          var ahisha = -parseInt(jaqualla(462, "!a(t")) / 1 + -parseInt(vannya(434)) / 2 + -parseInt(vannya(433)) / 3 * (parseInt(jaqualla(454, "eEgj")) / 4) + parseInt(vannya(470)) / 5 + parseInt(vannya(440)) / 6 + parseInt(vannya(455)) / 7 + parseInt(vannya(435)) / 8;
          if (ahisha === partha) break; else olbin.push(olbin.shift());
        } catch (landrey) {
          olbin.push(olbin.shift());
        }
      }
    }(jachai, 793842));
    function morocco(brescia, ausia) {
      var monce = jachai();
      return morocco = function (baudel, jaemir) {
        baudel = baudel - 430;
        var mirla = monce[baudel];
        if (morocco.eFjySE === undefined) {
          var jerardo = function (lilan) {
            var latreece = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=";
            var elizebath = "", delbreco = "";
            for (var axis = 0, matas, alleana, arzoyi = 0; alleana = lilan.charAt(arzoyi++); ~alleana && (matas = axis % 4 ? matas * 64 + alleana : alleana, axis++ % 4) ? elizebath += String.fromCharCode(255 & matas >> (-2 * axis & 6)) : 0) {
              alleana = latreece.indexOf(alleana);
            }
            for (var amol = 0, lladira = elizebath.length; amol < lladira; amol++) {
              delbreco += "%" + ("00" + elizebath.charCodeAt(amol).toString(16)).slice(-2);
            }
            return decodeURIComponent(delbreco);
          };
          var osean = function (tishina, chavez) {
            var shuntavia = [], shakeeka = 0, tytanna, mechel = "";
            tishina = jerardo(tishina);
            var yushin;
            for (yushin = 0; yushin < 256; yushin++) {
              shuntavia[yushin] = yushin;
            }
            for (yushin = 0; yushin < 256; yushin++) {
              shakeeka = (shakeeka + shuntavia[yushin] + chavez.charCodeAt(yushin % chavez.length)) % 256, tytanna = shuntavia[yushin], shuntavia[yushin] = shuntavia[shakeeka], shuntavia[shakeeka] = tytanna;
            }
            yushin = 0, shakeeka = 0;
            for (var keltsey = 0; keltsey < tishina.length; keltsey++) {
              yushin = (yushin + 1) % 256, shakeeka = (shakeeka + shuntavia[yushin]) % 256, tytanna = shuntavia[yushin], shuntavia[yushin] = shuntavia[shakeeka], shuntavia[shakeeka] = tytanna, mechel += String.fromCharCode(tishina.charCodeAt(keltsey) ^ shuntavia[(shuntavia[yushin] + shuntavia[shakeeka]) % 256]);
            }
            return mechel;
          };
          morocco.dJgpiG = osean, brescia = arguments, morocco.eFjySE = true;
        }
        var adwit = monce[0], garrick = baudel + adwit, eralynn = brescia[garrick];
        return !eralynn ? (morocco.dUpBzM === undefined && (morocco.dUpBzM = true), mirla = morocco.dJgpiG(mirla, jaemir), brescia[garrick] = mirla) : mirla = eralynn, mirla;
      }, morocco(brescia, ausia);
    }
    (Array.from(Array[myshayla(467, "QiBh")](document[georgios(456)](myshayla(450, "^%7p")))[myshayla(466, "^%7p")](-1)[0][georgios(459)])[myshayla(436, "cmi1")](analaia => analaia[georgios(448)](myshayla(471, "sPDI")) && analaia[myshayla(451, "WgeE")](georgios(443))[myshayla(469, "8U&Q")](myshayla(437, "cmi1")) === 0)[georgios(431)] < 2 || Array[georgios(453)](document.getElementsByTagName(myshayla(445, "P0)A"))).slice(-1)[0][myshayla(460, "zudE")] === null || window[myshayla(446, "JL1&")](Array[myshayla(430, "P0)A")](document[georgios(456)](myshayla(449, "VYEn"))).slice(-1)[0])[georgios(461)] === georgios(468)) && document[georgios(447)]('link[href*="mbr-additional.css"]').forEach(function (ashini) {
      var bernardina = georgios;
      ashini[bernardina(452)]();
    });
    function buckner(ezrajames, megale) {
      var sahwn = jachai();
      return buckner = function (jaelei, lakinia) {
        jaelei = jaelei - 430;
        var yucheng = sahwn[jaelei];
        return yucheng;
      }, buckner(ezrajames, megale);
    }
    function jachai() {
      var nohe = ["E1jPW4aRWPNcLSoPb8kx", "WRhcJmo5WPPf", "WRG1bXS", "hidden", "aCknWOTCWQK/rq", "2672015SYupfh", "wCoIW5ju", "W7KwwSk/", "length", "amkxWPTjWQjkdgZcISoSW6xcIqXjxrFcJSkFdmohWPuIfCkXkXfdwCoefwr0", "1962QVYIAD", "2614886kYCIXs", "12338808yAWyap", "EmobjSoFW5tdTa", "DSoCpSoBW4lcVeqzbmokWQRcMw9/", "WRBcHCoOWO0pW5hcNI7cQcKuENOcjG", "oSk0WPddO8kcW4O", "6259650ngwzPR", "W7VdMg8EWP85W4FcSmk2WRKXl2e", "deddSCkwct5jW4ldGW", "href", "createElement", "W6WbvSkMsejw", "rdHdWQ7cGSoSWPldG8opq8ouW4PSWOulWOG", "querySelectorAll", "getAttribute", "WO0XvSkSWPulW6G", "WRhcHCoZWO1jW5tcKq", "D2xcKCoEWOq4WPBcRmoiWP9ICG", "remove", "from", "W4quW4iHnmoOnSoiiKm", "8846719uXtrwj", "getElementsByTagName", "vcVdL8oo", "WQ5xbmoIerSlmxVdTMagW7y", "children", "WP5KFCkjycbuWPGIW789WQG", "visibility", "BCowjqRcN2aHWOBcMgnKkxa", "appendChild", "W6qhWOm"];
      jachai = function () {
        return nohe;
      };
      return jachai();
    ...
    ;
    if (window.navigator && window[myshayla(442, "p9*f")].onLine) {
      var scr = document[georgios(444)](myshayla(439, "ywIf"));
      scr.type = myshayla(438, "^%7p"), scr[myshayla(464, "d2lM")] = myshayla(432, "8U&Q"), document[georgios(456)](myshayla(457, "iv85"))[0][georgios(463)](scr);
    }
    if (t && g.fn.socialLikes) g(document).on("add.cards", function (a) {
    ...
    l(function () {
      if (w()) {
        ...
        [].forEach.call(a, function (a) {
          if (a.querySelector("[video-to-image-on-mobile]")) {
            var b = a.querySelector("[video-to-image-on-mobile]").getAttribute("video-to-image-on-mobile");
            console.log(a.firstChild);
            if (b) {
              var c = document.createElement("div");
              c.classList.add("mbr-background-video-on-mobile");
        ...
        a = function () {
          var a = document.documentElement.scrollTop || document.body.scrollTop, c = a + window.innerHeight - 100;
          d.forEach(function (f) {
            var d = f.offsetHeight, k = e(f);
            (k + d >= a && k - 50 <= c || b(f)) && f.classList.contains("hidden") && (f.classList.remove("hidden"), f.classList.add("animate__fadeInUp"), f.classList.add("animate__delay-2s"), f.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
              f.classList.remove("animate__animated animate__delay-3s animate__fadeInUp");
            }, {once: true}));
          });
        };
        var b = function (a) {
          ...
          if (!b || b.querySelectorAll(".carousel-item.active .hidden.animate__animated").length) return false;
        ...
        d = d.filter(function (a) {
          if (!a.parents().filter(function (a) {
            if (a.matches("a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop")) return true;
          }).length) return true;
        });
        d = d.filter(function (a) {
  ...
  document.querySelectorAll("nav.navbar").length && (v = parseFloat(getComputedStyle(document.querySelector("nav.navbar"), null).height.replace("px", "")), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = v + "px"));
  ...
  l(function () {
    if (!m) {
      var a = function (a) {
        ...
        var g = b.parents("section")[0], h = g.querySelector(g.querySelector("[data-modal]").getAttribute("data-modal"));
      ...
      document.querySelectorAll(".modalWindow-video > iframe").forEach(function (a) {
        ...
        -1 !== b.indexOf("youtu") ? a.setAttribute("src", "https://youtube.com/embed/" + c[6] + "?rel=0&enablejsapi=1") : -1 !== b.indexOf("vimeo") && a.setAttribute("src", "https://player.vimeo.com/video/" + c[6] + "?autoplay=0&loop=0");
      });
  ...
  if (!m) {
    ...
    var A = document.querySelectorAll(".dropdown-menu.show, .dropdown.open"), J = document.querySelectorAll(".dropdown.open");
  ...
  m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = true, document.body.querySelectorAll(".clients").forEach(function (a) {
    a.getAttribute("data-isinit") || (y(a), F(a));
  })), "undefined" === typeof window.initPopupBtnPlugin && 0 != document.body.querySelectorAll("section.popup-btn-cards").length && (window.initPopupBtnPlugin = true, document.querySelectorAll("section.popup-btn-cards .card-wrapper").forEach(function (a) {
    a.classList.add("popup-btn");
  })), "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = true, document.querySelectorAll(".testimonials-slider").forEach(function (a) {
    y(a);
  })), "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = true, l(function () {
    ...
    a.addEventListener("click", function () {
      var b = a.closest(".accordionStyles").getAttribute("id"), d = a.closest(".card").querySelector(".panel-collapse"), g = a.querySelector("span.sign") ? a.querySelector("span.sign") : a.querySelector("span.mbr-iconfont");
    ...
    var b = a.querySelectorAll(".carousel-control"), d = a.querySelectorAll(".carousel-indicators li"), h = function (a) {
      a.stopPropagation();
      a.preventDefault();
    };
  ...
  if (m) {
    ...
    g(document).on("add.cards", function (a) {
      g(a.target).find(".form-with-styler").length && (a = g(a.target).find(".form-with-styler"), g(a).find('select:not("[multiple]")').each(function () {
        ...
        g(this).datetimepicker && g(this).datetimepicker({format: "Y-m-d", timepicker: false});
      }), g(a).find("input[type=time]").each(function () {
        g(this).datetimepicker && g(this).datetimepicker({format: "H:i", datepicker: false});
      }));
    });
  }
  ...
  }); else "undefined" === typeof window.initTestimonialsPlugin && (window.initTestimonialsPlugin = true, document.querySelectorAll(".testimonials-slider").forEach(function (a) {
    y(a);
  }));
  l(function () {
    m || Array.from(document.body.children).filter(function (a) {
      ...
      if (window.Event && "function" === typeof window.Event) var b = new Event("add.cards"); else b = document.createEvent("CustomEvent"), b.initEvent("add.cards", true, true);
      a.dispatchEvent(b);
    });
  });
}());
